      ...
      items: [
        {
          ...
          description:
            "The vision behind Replaysafe and core monitoring pillars.",
        },
        {
          title: "Quick Start",
          href: "/docs/introduction#quick-start",
          description:
            "Get your first heartbeat monitor running in 60 seconds.",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          description:
            "Strategies for homelabs, media stacks, and local AI stability.",
        },
        {
          title: "Architecture & Deployment",
          href: "/docs/architecture",
          description:
            "A deep dive into our modular stack and advanced deployment strategies.",
        },
      ],
    },
    {
      ...
      items: [
        {
          title: "RBAC Roles",
          href: "/docs/architecture#rbac",
          description: "Managing projects with Owner, Admin, and Member roles.",
        },
        {
          title: "Encryption",
          href: "/docs/architecture#encryption",
          description: "How we protect your secrets at rest using AES-256-GCM.",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          description: "Payload specs for pushing heartbeats to Replaysafe.",
        },
        {
          title: "Intelligence API",
          href: "/docs/api-reference#intelligence-api",
          description: "Querying health scores and failure patterns.",
        },
      ],
    },
  ];
      ...
      <div className="max-w-5xl mx-auto space-y-24">
        ...
        <div className="space-y-6">
          ...
          <p className="text-muted-foreground text-xl max-w-2xl font-medium">
            Everything you need to build, scale, and secure your monitoring
            infrastructure with Replaysafe.
          </p>
        </div>
        ...
        <div className="glass-panel border border-border/10 rounded-[3rem] p-12 bg-acid-lime/5">
          <h2 className="text-3xl font-black uppercase tracking-tighter mb-12 text-center italic">
            Advanced <span className="text-acid-lime">Intelligence</span>{" "}
            Built-In
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center space-y-4">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Sensitive webhook URLs are never stored in plaintext. Encrypted
                at the field level.
              </p>
            </div>
            <div className="text-center space-y-4">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Full traceability for every mutation. Know exactly who changed
                what and when.
              </p>
            </div>
            <div className="text-center space-y-4">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Identify recurring failure windows and flapping monitors
                automatically.
              </p>
            </div>
          </div>
        ...
        <div className="text-center pt-12">
          <p className="text-muted-foreground text-sm font-medium">
            Need custom help?{" "}
            <span className="text-foreground font-black uppercase tracking-widest cursor-pointer hover:text-acid-lime transition-colors">
              Join our Discord
            </span>
          </p>
        </div>
