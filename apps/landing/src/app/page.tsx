  ...
  return (
    <div className="antialiased min-h-screen flex flex-col relative bg-background bg-tech-grid overflow-x-hidden text-foreground z-0">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-50">
        <div
          className="particle"
          style={{ left: "10%", animationDelay: "0s", height: "150px" }}
        ></div>
        <div
          className="particle"
          style={{ left: "30%", animationDelay: "2s", height: "80px" }}
        ></div>
        <div
          className="particle"
          style={{ left: "70%", animationDelay: "1.5s", height: "200px" }}
        ></div>
        <div
          className="particle"
          style={{ left: "85%", animationDelay: "0.5s", height: "120px" }}
        ></div>
      </div>
      ...
      <main className="flex-grow pt-40 pb-xl px-margin max-w-7xl mx-auto w-full flex flex-col items-center gap-xl relative z-10">
        ...
        <section className="text-center flex flex-col items-center gap-lg max-w-4xl mx-auto mt-8">
          ...
          <h1 className="text-headline-xl font-headline-xl text-foreground uppercase tracking-tight">
            The <span className="glow-lime font-black">Safety Layer</span>
            <br />
            <span className="text-foreground/40 font-black italic">
              For AI Agents.
            </span>
          </h1>
          ...
          <div className="flex flex-col items-center gap-lg mt-15">
            <a
              href="https://github.com/JobGuards/Replaysafe"
              className="bg-acid-lime text-primary-foreground px-sm py-sm rounded-full font-black uppercase tracking-widest text-sm shadow-[0_0_20px_rgba(var(--theme-lime-rgb),0.3)] hover:shadow-[0_0_40px_rgba(var(--theme-lime-rgb),0.6)] transition-all duration-500 flex items-center gap-xs transform hover:-translate-y-1"
            >
            ...
            <div className="flex flex-col items-center gap-2">
              <div className="bg-zinc-950 rounded-xl p-1 flex items-center shadow-2xl border border-white/10 group overflow-hidden">
                <div className="px-md py-sm font-code-md text-sm md:text-base flex items-center gap-sm">
                  <span className="text-acid-lime font-bold select-none">
                    ❯
                  </span>
                  <span className="text-zinc-100 font-medium selection:bg-acid-lime/30">
                    {INSTALL_COMMAND}
                  </span>
                </div>
                <button
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.25em] text-muted-foreground/40 italic">
          ...
          <div className="glass-panel micro-border-lime rounded-3xl p-12 relative overflow-hidden shadow-[0_0_50px_rgba(217,255,0,0.05)] bg-[#0d0d15]/80">
            ...
            >
              <path
                ...
                d="M 500,200 L 250,200 L 250,100 L 100,100"
                fill="none"
              ></path>
              <path
                className="circuit-line"
                d="M 500,200 L 750,200 L 750,300 L 900,300"
                fill="none"
                style={{ animationDelay: "-1s" }}
              ></path>
              <path
                className="circuit-line"
                d="M 500,200 L 500,50 L 750,50 L 900,50"
                fill="none"
                ...
                <div className="glass-panel rounded-2xl p-6 flex flex-col gap-4 border-border/10 hover:border-acid-lime/50 transition-all hover:shadow-[0_0_20px_rgba(217,255,0,0.1)] relative overflow-hidden group">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-[10px] text-muted-foreground font-code-md uppercase tracking-widest">
                        Retry_Attempt_02
                      </div>
                    </div>
                  </div>
                ...
                <div className="glass-panel rounded-2xl p-6 flex flex-col gap-4 border-border/10 hover:border-acid-lime/50 transition-all hover:shadow-[0_0_20px_rgba(217,255,0,0.1)] relative overflow-hidden group bg-acid-lime/[0.02]">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-[10px] text-acid-lime font-code-md uppercase tracking-widest">
                        ReplayGuard
                      </div>
                    </div>
                  </div>
          ...
          <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-10">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed font-medium">
                ...
                agent job shouldn't charge your customer twice or corrupt your
                database.
              </p>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Automatically pause and verify dangerous actions
                      (Payments, Emails, DB Writes) before they execute.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Replaysafe remembers the outcome of successful steps. On
                      retry, we skip the action and replay the original result.
                    </p>
                  </div>
                </div>
              </div>
              <div className="pt-6">
                <a
                  href={`${dashboardUrl}/dashboard/guards`}
                  className="text-acid-lime font-black uppercase tracking-widest text-xs flex items-center gap-2 group hover:gap-4 transition-all"
                >
            ...
            <div className="relative">
              ...
              <div className="glass-panel rounded-[3rem] border-border/10 p-8 shadow-2xl relative bg-[#0a0a0f]/90 overflow-hidden group">
                <div className="flex items-center justify-between mb-10">
                  ...
                  <span className="text-[10px] font-code-md text-acid-lime/40">
                    JOB_ID: agent-992
                  </span>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-5 rounded-2xl bg-acid-lime/5 border-2 border-acid-lime/20 flex items-center justify-between shadow-[0_0_30px_rgba(var(--theme-lime-rgb),0.1)] relative overflow-hidden">
                    <div className="absolute top-0 right-0 p-2 opacity-5 scale-150">
                      <Zap className="w-12 h-12 text-acid-lime" />
                    </div>
                    <div className="flex items-center gap-4 relative z-10">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-[9px] font-black text-acid-lime uppercase italic">
                          Intercepted: Already Paid
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="p-5 rounded-2xl bg-foreground/[0.02] border border-border/5 flex items-center justify-between border-dashed">
                    <div className="flex items-center gap-4">
                      ...
                      <span className="text-xs font-bold uppercase tracking-tight text-muted-foreground/40">
                        Send Receipt
                      </span>
                    </div>
        ...
        <section className="w-full py-24 relative overflow-hidden">
          ...
          <div className="mt-16 w-full mx-auto">
            ...
            <div className="flex flex-wrap justify-center items-center gap-3">
              {[
                ...
                >
                  <span className="text-sm" style={{ color: fw.color }}>
                    {fw.icon}
                  </span>
          ...
          <div className="mt-12 w-full max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-14 text-left">
            ...
            <div className="rounded-2xl border border-destructive/20 bg-destructive/5 overflow-hidden">
              ...
              <pre className="text-xs font-mono text-muted-foreground p-4 overflow-x-auto leading-relaxed">
                <code>{`// LangGraph node - UNSAFE on retry
  ...
  return { chargeId: charge.id };
            ...
            <div className="rounded-2xl border border-acid-lime/20 bg-acid-lime/5 overflow-hidden">
              <div className="flex items-center gap-2 px-4 py-2 border-b border-acid-lime/10 bg-acid-lime/10">
                <span className="w-2 h-2 rounded-full bg-acid-lime animate-pulse"></span>
                <span className="text-[10px] font-black uppercase tracking-widest text-acid-lime/70">
                  With ReplayGuard
                </span>
              </div>
              <pre className="text-xs font-mono text-muted-foreground p-4 overflow-x-auto leading-relaxed">
                <code>{`// LangGraph node - SAFE on retry
async function chargeNode(state, guard) {
  ...
  return { chargeId: charge.id };
        ...
        <section className="w-full py-24 relative overflow-hidden">
          <div className="text-center mb-20">
            ...
            <p className="text-muted-foreground mt-8 max-w-2xl mx-auto text-lg leading-relaxed">
              Know when the infrastructure your agents depend on starts to
              degrade - before a retry turns into a disaster.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-6xl mx-auto px-6">
            <div className="glass-panel p-10 rounded-[2.5rem] border-border/10 bg-card/30 backdrop-blur-xl group hover:border-acid-lime/30 transition-all duration-500">
              ...
              <h4 className="text-xl font-black uppercase tracking-tight italic mb-4">
            ...
            <div className="glass-panel p-10 rounded-[2.5rem] border-border/10 bg-card/30 backdrop-blur-xl group hover:border-acid-lime/30 transition-all duration-500">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                WireGuard and SSH tunnels fail silently - the process stays UP
                while data stops flowing. Sentinel detects stale handshakes and
                latency spikes before they break autonomous access.
              </p>
            </div>
      ...
      <section className="w-full max-w-7xl mx-auto px-margin py-xl flex flex-col items-center gap-lg">
        ...
        <h2 className="text-headline-lg font-headline-lg text-foreground text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-md w-full mt-4">
          <div className="glass-panel rounded-xl p-lg flex flex-col gap-md border border-border/20 hover:border-acid-lime/30 transition-all">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Agent charges a customer, DB write fails, agent retries - and
              charges again. ReplayGuard fingerprints the charge and skips
              execution on retry. The customer is never billed twice.
            </p>
          </div>
          <div className="glass-panel rounded-xl p-lg flex flex-col gap-md border border-border/20 hover:border-acid-lime/30 transition-all">
            <div className="w-10 h-10 rounded-xl bg-acid-lime/10 flex items-center justify-center border border-acid-lime/20">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Every agent retry re-runs every LLM call from scratch.{" "}
              <span className="font-mono text-acid-lime/80">guard.ai()</span>{" "}
              caches completions - if the same call already ran, the cached
              result is returned. No second API bill.
            </p>
          </div>
          <div className="glass-panel rounded-xl p-lg flex flex-col gap-md border border-border/20 hover:border-acid-lime/30 transition-all">
            <div className="w-10 h-10 rounded-xl bg-acid-lime/10 flex items-center justify-center border border-acid-lime/20">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Agent runs 50 tool calls, fails at step 48, retries from scratch.
              ReplayGuard skips steps 1–47, resumes at 48. No duplicate side
              effects. No wasted compute.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="w-full max-w-3xl mx-auto px-margin py-xl flex flex-col gap-lg">
        <h2 className="text-headline-lg font-headline-lg text-foreground text-center md:text-left">
        ...
        <div className="flex flex-col border-t border-border/20">
          {faqs.map((faq, i) => (
            <div
              key={i}
              className="border-b border-border/20 flex flex-col cursor-pointer group"
              onClick={() => setOpenFaq(openFaq === i ? null : i)}
            >
              <div className="py-md flex items-center justify-between">
                <span className="text-body-lg font-headline-md text-foreground group-hover:text-primary transition-colors">
                  {faq.q}
                </span>
                <ChevronDown
                  className="text-muted-foreground transition-transform w-5 h-5"
                  style={{
              ...
              {openFaq === i && (
                <div className="pb-md text-muted-foreground text-body-md font-body-md">
                  {faq.a}
                </div>
              )}
            </div>
