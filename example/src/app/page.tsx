...
export default function Home() {
  ...
  const handleCheckout = async (planId: string) => {
    try {
      ...
      if (!(window as any).Razorpay) {
        throw new Error(
          "Razorpay SDK not loaded. Check internet connection or layout script.",
        );
      }
      ...
      const options = {
        ...
        handler: async (response: any) => {
          addLog(
            `Razorpay Authorized! Payment ID: ${response.razorpay_payment_id}`,
            "success",
          );
  ...
  const verifyPayment = async (payload: any) => {
    try {
      addLog(
        `Sending verification request (Attempt #${payload.attemptNumber})...`,
        "info",
      );
      setLoading("verify");
      ...
      addLog(
        `Safe Retry Available: Click the "Retry Verification" button below.`,
        "warning",
      );
      setLoading(null);
    }
  ...
  const triggerRetry = async () => {
    ...
    addLog(
      `Manually triggering retry for order: ${retryPayload.razorpay_order_id}`,
      "warning",
    );
  ...
  return (
    <div className="container">
      ...
      <section className="hero">
        ...
        <p>
          Simulate payment fulfillment retries. Toggle "Simulate Server Crash"
          to see how ReplayGuard ensures orders are fulfilled exactly once even
          when the server crashes mid-workflow.
        </p>
      </section>
      ...
      <div className="grid">
        ...
        <div className="card">
          ...
          <p className="card-description">
            Perfect for small teams and developers testing sandboxes.
          </p>
          ...
          <ul className="card-features">
            <li>
              <Check size={16} /> 100 Demo Credits
            </li>
            <li>
              <Check size={16} /> Basic monitoring logs
            </li>
            <li>
              <Check size={16} /> Standard API access
            </li>
          </ul>
          <button
            className="btn"
        ...
        >
          ...
          <p className="card-description">
            Advanced features, suitable for scaling agentic apps.
          </p>
          <div className="card-price-container">
            <span className="card-currency">₹</span>
          ...
          <ul className="card-features">
            <li>
              <Check size={16} /> 500 Demo Credits
            </li>
            <li>
              <Check size={16} /> Instant webhooks &amp; rollbacks
            </li>
            <li>
              <Check size={16} /> High integrity fail policy
            </li>
          </ul>
          <button
            className="btn"
        ...
        <div className="card">
          ...
          <p className="card-description">
            For mission-critical production systems needing full uptime.
          </p>
          <div className="card-price-container">
            <span className="card-currency">₹</span>
          ...
          <ul className="card-features">
            <li>
              <Check size={16} /> 3,000 Demo Credits
            </li>
            <li>
              <Check size={16} /> Custom circuit breaking rules
            </li>
            <li>
              <Check size={16} /> Dedicated guard sentinel
            </li>
          </ul>
          <button
            className="btn"
      ...
      <section className="test-section">
        ...
        <div className="console">
          {logs.length === 0 ? (
            <div className="console-line info">
              Logs will appear here when you trigger payments...
            </div>
          ) : (
            logs.map((log, i) => (
        ...
        <div className="controls">
          <label className="checkbox-container">
            ...
            />
            Simulate Server Crash Post-Fulfillment (Throws 500 error after DB
      ...
      <footer className="footer">
        Powered by <strong>Replaysafe Guard SDK</strong> &amp;{" "}
